...
COMPARE_LLM_HISTORY = os.environ.get('COMPARE_LLM_HISTORY', '').lower() in {'1', 'true', 'yes'} or str(DISAMBIG_MODE).lower() == 'three_factor_compare'
FORCE_NO_ASK = os.environ.get('FORCE_NO_ASK', '').lower() in {'1', 'true', 'yes'}
CONCEPT_MATCH_MODE = os.environ.get('CONCEPT_MATCH_MODE', 'pred_furn_backoff').strip().lower()
...
CONCEPT_ACTION_WEIGHT = float(os.environ.get('CONCEPT_ACTION_WEIGHT', '0.7'))
CONCEPT_ENV_WEIGHT = float(os.environ.get('CONCEPT_ENV_WEIGHT', '0.3'))
CONCEPT_TOPK = int(os.environ.get('CONCEPT_TOPK', '3'))
CONCEPT_ENV_MAX_SRC = int(os.environ.get('CONCEPT_ENV_MAX_SRC', '24'))
CONCEPT_ENV_WEAK_MARGIN = float(os.environ.get('CONCEPT_ENV_WEAK_MARGIN', '0.03'))
CONCEPT_ENV_WEAK_SCALE = float(os.environ.get('CONCEPT_ENV_WEAK_SCALE', '0.25'))
CONCEPT_FURN_NMIN = int(os.environ.get('CONCEPT_FURN_NMIN', '6'))
CONCEPT_FURN_BACKOFF = float(os.environ.get('CONCEPT_FURN_BACKOFF', '0.85'))
CONCEPT_ENV_PRED_NMIN = int(os.environ.get('CONCEPT_ENV_PRED_NMIN', '12'))
CONCEPT_ENV_PRED_BACKOFF = float(os.environ.get('CONCEPT_ENV_PRED_BACKOFF', '0.80'))
...
CONCEPT_HABIT_MIN_LIFT = float(os.environ.get('CONCEPT_HABIT_MIN_LIFT', '1.05'))
...
CONCEPT_IDF_GAMMA = float(os.environ.get('CONCEPT_IDF_GAMMA', '0.60'))
CONCEPT_LOCAL_DISC_GAMMA = float(os.environ.get('CONCEPT_LOCAL_DISC_GAMMA', '1.10'))
CONCEPT_MIN_LOCAL_DISC = float(os.environ.get('CONCEPT_MIN_LOCAL_DISC', '0.05'))
